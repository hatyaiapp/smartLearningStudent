                    ...
                    {!this.state.isStart ?
                        ...
                        <div style={{ zIndex: 2, width: '85vw', height: '80vh', backgroundColor: '#fff', alignSelf: 'center', borderRadius: 20, display: 'flex', flexDirection: 'row' }}>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', backgroundColor: '#98def8', marginBottom: 10, marginTop: 10, marginLeft: 10, border: '2px solid #23b8f0', borderRadius: 10, overflow: 'hidden' }}>
                                    ...
                                    <div style={{ backgroundColor: '#fff' }}>
                                        <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                                            ...
                                            <span style={{ fontFamily: 'DBH', fontWeight: 500, fontSize: '1.5vw' }}>: John Doe</span>
                                        </div>
                                        <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                                            <FontAwesomeIcon icon={faClock} style={{ width: '1.6vw' }} />
                                            <span style={{ fontFamily: 'DBH', fontWeight: 500, fontSize: '1.5vw' }}>: {this.getTimeTxt(900)}</span>
                                        </div>
                                        <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                                            <FontAwesomeIcon icon={faFileAlt} style={{ width: '1.6vw' }} />
                                            <span style={{ fontFamily: 'DBH', fontWeight: 500, fontSize: '1.5vw' }}>: แบบทดสอบ ก</span>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div style={{ display: 'flex', flex: 1, overflowY: 'scroll', }}>
                                            <div style={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap', alignSelf: 'flex-start' }}>
                                                {this.state.data.map((d, index) => {
                                                    return (
                                                        <Button onClick={() => this.setState({ current: index })} style={{ width: '1.5vw', height: '1.5vw', border: this.state.current === index ? '2px solid #337ab7' : '2px solid transparent', backgroundColor: this.state.answer[index] !== undefined ? '#44b29c' : '#d9d5d5', marginTop: 2, marginLeft: 2, padding: 0 }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', flex: 4 }}>
                                <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                    <h1 style={{ fontFamily: 'DBH', fontWeight: 'bolder', color: '#ff5f6d', fontSize: '3vw', textAlign: 'left', marginTop: 10, marginLeft: 50 }}>ข้อที่ {this.state.current + 1} จาก {this.state.data.length}</h1>
